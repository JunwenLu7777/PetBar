...
private func assertDynamicIslandTaskWorkspace() {
    ...
    let codexRunning = TaskProgressItem(
        ...
        workingDirectory: "/tmp/chatbird/../chatbird",
    ...
    guard acknowledgedDetails == [codexRunning.identityKey],
          windowController.copyWorkingDirectoryForSelfTest("/tmp/chatbird/../chatbird"),
          copiedPaths == ["/tmp/chatbird/../chatbird"]
    else {
        fputs(
...
private func assertDynamicIslandPreviewRendering() {
    ...
    let temporaryURL = FileManager.default.temporaryDirectory
        .appendingPathComponent("chatbird-dynamic-island-preview-self-test.png")
    do {
