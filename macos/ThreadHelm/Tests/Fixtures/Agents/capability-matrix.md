...
- Task cards surface public assistant narration read from the local `brain/<conversationId>/.system_generated/logs/transcript_full.jsonl` (PLANNER_RESPONSE/MODEL records only; tool output, user input, and system records are never displayed).
